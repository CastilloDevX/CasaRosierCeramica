...
export { LOCAL_ADMIN_EMAIL, LOCAL_ADMIN_PASSWORD, LOCAL_AUTH_SECRET, LOCAL_SESSION_COOKIE, createLocalSessionToken, readLocalSessionToken, validateLocalCredentials } from "./local-auth-core";
