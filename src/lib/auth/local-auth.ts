...
export { LOCAL_ADMIN_EMAIL, LOCAL_ADMIN_PASSWORD_HASH, LOCAL_AUTH_SECRET, LOCAL_SESSION_COOKIE, createLocalSessionToken, readLocalSessionToken, validateLocalCredentials } from "./local-auth-core";
